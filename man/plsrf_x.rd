...
\title{Classification based on PLS dimension reduction and random forests using microarray data only}
\usage{
plsrf_x(Xlearn,Zlearn=NULL,Ylearn,Xtest,Ztest=NULL,ncomp=0:3,ordered=NULL,nbgene=NULL,...)
}
\arguments{
...
as 0,...,K-1 (where K is the number of classes).}
  ...
  \item{Ztest}{A ntest x q matrix giving the clinical predictors for the test data set. This argument is ignored.}
    \item{ncomp}{A numeric vector giving the candidate numbers of PLS components. All numbers must be >0.}
